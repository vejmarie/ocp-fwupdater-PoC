...
// Settings for the Winbond W25Q256JV-SQ 32MiB SPI flash. Note that JV-IM has a
// different .memory_type (0x70) Datasheet:
// https://www.winbond.com/hq/support/documentation/downloadV2022.jsp?__locale=en&xmlPath=/support/resources/.content/item/DA00-W25Q256JV.html&level=1

func W25Q256JVSQ() Attrs {
        return Attrs{
                TotalSize:           1 << 25, // 16 MiB
                StartUp:             5000 * time.Microsecond,
                JedecID:             JedecID{0xEF, 0x40, 0x19},
                MaxClockSpeedMHz:    133,
                QuadEnableBitMask:   0x02,
                HasSectorProtection: false,
                SupportsFastRead:    true,
